...
const_value = 0
	...
	const UNUSED_EFFECT_23           ; $23 'make attract maybes?
	...
	const ACCURACY_DOWN_SIDE_EFFECT;const UNUSED_EFFECT_48           ; $48
	const EVASION_DOWN_SIDE_EFFECT;UNUSED_EFFECT_49           ; $49
	const ATTACK_UP_SIDE_EFFECT           ; $4A unused_effect_4a
	const SPEED_UP_SIDE_EFFECT           ; $4B unused
	...
	const THUNDER_FANG_EFFECT        ;
  const VOLT_TACKLE_EFFECT         ;EQU $5A
  const POISON_FANG_EFFECT         ;EQU $5B
  const SUCKER_PUNCH_EFFECT        ;EQU $5C
