BeachHouseScript:
	call EnableAutoTextBoxDrawing;call $3c29 hopefully should fix pikachu botching up here. it does, but the pikachu run up to you script does not seem to work (or did not on my first try), so I am suspicious that this may not actually be the proper replacement?
	ret
...
.BeachHousePrinterText3
	...
	db "@"
.BeachHousePrinterText4 ;dogs and burgers
