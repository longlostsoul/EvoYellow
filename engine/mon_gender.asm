...
MonGenderRatios:
	...
	db SAME_BOTH_GENDERS ; was slug, now rockruff
  ...
  db SAME_BOTH_GENDERS;was const DEX_REMORAID now carvanha/sharpedo fam
...
db MALE_75_PERCENT;const DEX_LUCARIO
  ...
  db SAME_BOTH_GENDERS;OBSTAGOON
  db FEMALE_75_PERCENT;SPINARAK now joltik
  db FEMALE_75_PERCENT;ARIADOS
  db NO_GENDER;MANTYKE now celebi
  db SAME_BOTH_GENDERS;MANTINE
  db MALE_75_PERCENT;was AIPOM now pineco
  db MALE_75_PERCENT;was AMBIPOM
  db SAME_BOTH_GENDERS;MUNCHLAX
  db SAME_BOTH_GENDERS;MIMIKYU
  db NO_GENDER;SUICUNE
  db NO_GENDER;ENTEI
  db NO_GENDER;RAIKOU
 ; db SAME_BOTH_GENDERS;MEGA_CHARIZARD
 ; db SAME_BOTH_GENDERS;MEGA_BLASTOISE
 ; db SAME_BOTH_GENDERS;MEGA_VENUSAUR
