...
MonGenderRatios:
  ...
  db SAME_BOTH_GENDERS;const DEX_SUNKERN
  db SAME_BOTH_GENDERS;const DEX_SUNFLORA
...
db SAME_BOTH_GENDERS;const DEX_SENTRET
db SAME_BOTH_GENDERS;const DEX_FURRET
db SAME_BOTH_GENDERS;const DEX_QWILFISH
db SAME_BOTH_GENDERS;const DEX_DELIBIRD
