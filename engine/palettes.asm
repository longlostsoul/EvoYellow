...
.nextcolor2
	...
	cp 3
	jr nz, .nextcolor3
	ld a,PAL_PINKMON ;like orange islands, have pink mons!
	;add (4)
	jr .done
.nextcolor3
	cp 5
...
.nextcolor4
	cp 6
	jr nz, .nextcolor5
	ld a,PAL_SHINY ;blackmon. shiny charizard.
	jr .done
.nextcolor5
	cp 7
	jr nz, .nextcolor6
	ld a,PAL_REDMON ;give us a shiny gyarados please
	jr .done
.nextcolor6
	ld a,[wTemp]
	cp 4
	...
	;ld a,b
	ld a,PAL_YELLOWMON 
	;add (5) ;original was just adding.
	jr .done
.nope
 ld a,b
.done
