PokedexEntryPointers:
  ...
  dw NewDexEntry ;mag
	...
	dw MagmarDexEntry;magmor
	dw ElectabuzzDexEntry;el
	dw MagnetonDexEntry ;magne
	dw RhydonDexEntry ;rhyperio
	dw TangelaDexEntry;tan
  dw LickitungDexEntry ;licki
  dw EeveeDexEntry;esp
	dw EeveeDexEntry;umb
	dw EeveeDexEntry ;glac
	dw EeveeDexEntry ;leaf
