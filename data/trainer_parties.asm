...
LassData:
	...
	db 26,CLEFABLE,MR_RIME,CHANSEY,MR_RIME,0
	db 30,BLISSEY,OCTILLERY,WEEPINBELL,SKIPLOOM,0
	db 35,BELLOSSOM,GLOOM,LUCARIO,SIRFETCHD,SALAZZLE,0
	db 4,MAGNEMITE,CURSOLA,SIRFETCHD,ABSOL,RIOLU,0 ;first lass you fight
SailorData:
...
RocketData:
	...
	db 38,DROWZEE,GRIMER,MACHOKE,CURSOLA,0
	db 55,HOUNDOOM,LANTURN,HYPNO,ABSOL,0
