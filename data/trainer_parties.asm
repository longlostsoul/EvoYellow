...
LassData:
	...
	db 4,ZIGZAGOON,MANTYKE,PINECO,0 ;first lass you fight
SailorData:
...
CooltrainerMData:
	...
	db 70,GYARADOS,ZAPDOS,MOLTRES,ARTICUNO,MEWTWO,0;originally unused I think. Bill's team according to an untranslated Pokedex book.
