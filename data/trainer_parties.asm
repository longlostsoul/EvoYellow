...
BugCatcherData:
	...
	db 14,BUTTERFREE,SCYTHER,JOLTIK,0
	...
	db 18,BEEDRILL,BUTTERFREE,JOLTIK,PINSIR,0
	db 26,BUTTERFREE,SCIZOR,MARILL,GALVANTULA,0
...
PsychicData:
	...
	db 40,ESPEON,UMBREON,XATU,GALVANTULA,0
RockerData:
...
JugglerData:
	...
	db 38,GLACEON,KADABRA,GALVANTULA,0
...
TamerData:
	...
	db 50,ARBOK,MILTANK,DONPHAN,XATU,GALVANTULA,0
...
RocketData:
	...
	db 26,POLITOED,EKANS,SANDSLASH,GALVANTULA,0
...
BrockData:
  db $FF,14,ZUBAT,8,GEODUDE,9,ONIX,10,VULPIX,11,KABUTO,12,AERODACTYL,0 ;medium Brock
	db $FF,54,CROBAT,58,GOLEM,59,STEELIX,50,NINETALES,51,KABUTOPS,52,AERODACTYL,0 ;hard Brock
	db 10,GEODUDE,ONIX,PINECO,VULPIX,0 ;easy Brock.
MistyData:
	db $FF,24,GYARADOS,25,STARMIE,20,CORSOLA,24,LANTURN,20,QUAGSIRE,25,TOGEKISS,0
	db 20,PSYDUCK,TOGEPI,GOLDEEN,STARYU,STARMIE,0
LtSurgeData:
...
KogaData:
	db $FF,55,SANDSLASH,56,GALVANTULA,48,WEEZING,55,VENOMOTH,58,TENTACRUEL,65,SCIZOR,0
BlaineData:
