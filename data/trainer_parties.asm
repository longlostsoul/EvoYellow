...
LassData:
	...
	db 4,NIDORAN_F,CORSOLA,SALANDIT,RIOLU,0 ;first lass you fight
SailorData:
...
BirdKeeperData:
	...
	db 45,DRATINI,FEAROW,XATU,SIRFETCHD,0
...
RocketData:
	...
	db 20,AERODACTYL,ABSOL,SLUGMA,WOOPER,0
	...
	db 29,HOUNDOOM,MACHOKE,ABSOL,0
	...
	db 38,DROWZEE,GRIMER,MACHOKE,ABSOL,0
	db 55,HOUNDOOM,LANTURN,HYPNO,SIRFETCHD,0
...
ErikaData:
	db $FF,40,TANGROWTH,46,VICTREEBEL,44,VILEPLUME,40,SALANDIT,45,VENUSAUR,45,EXEGGUTOR,0
KogaData:
...
>>>>>>> parent of 57079e2... attempt to make compatible with master
