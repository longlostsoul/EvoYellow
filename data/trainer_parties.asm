...
CooltrainerMData:
	...
	db 70,CELEBI,GYARADOS,ZAPDOS,MOLTRES,ARTICUNO,MEWTWO,0;originally unused I think. Bill's team according to an untranslated Pokedex book, except Celebi, I added that because he invents time travel.
