...
LassData:
	...
	db 27,BLISSEY,OCTILLERY,WEEPINBELL,SKIPLOOM,0
	db 30,BELLOSSOM,GLOOM,LUCARIO,SUNFLORA,0
...
JrTrainerFData:
	...
	db 26,BULBASAUR,0
	db 26,TOGEPI,BELLSPROUT,ODDISH,BELLOSSOM,0
	...
	db 27,SQUIRTLE,BULBASAUR,CHARMANDER,0
	...
	db 28,BELLSPROUT,HOPPIP,CLEFAIRY,0
	db 25,MEOWTH,BELLOSSOM,GLACEON,0
...
BeautyData:
	...
	db 30,POLIWRATH,JYNX,SEAKING,LICKITUNG,CHARMELEON,0
	db 34,MAGMAR,SEAKING,0
...
JugglerData:
	...
	db 31,ARBOK,DROWZEE,KADABRA,SYLVEON,0
	db 34,LEAFEON,HYPNO,0
	db 48,MR_MIME,UMBREON,0
	db 33,HYPNO,VAPOREON,XATU,0
	db 38,GLACEON,KADABRA,0
	db 34,WIGGLYTUFF,KADABRA,JOLTEON,0
TamerData:
	db 37,SANDSLASH,ARBOK,PILOSWINE,0
	db 38,UMBREON,SANDSLASH,RHYHORN,0
	db 46,RHYHORN,DONPHAN,SKARMORY,0
	db 40,ARBOK,MILTANK,DONPHAN,XATU,0
	db 50,PERSIAN,GOLDUCK,MACHAMP,MAGMORTAR,0
	db 50,RHYPERIOR,PRIMEAPE,MAGNEZONE,TAUROS,TANGROWTH,0
BirdKeeperData:
...
BlackbeltData:
	...
	db 36,PRIMEAPE,POLIWHIRL,0
	db 31,TYROGUE,PERSIAN,PRIMEAPE,0
	db 40,MACHOP,MACHOKE,0
	db 43,MACHOKE,LUCARIO,0
	db 38,POLIWRATH,URSARING,MACHOKE,0
...
ScientistData:
	...
	db 36,PILOSWINE,MAGNETON,VOLTORB,0
	db 38,WOBBUFFET,ELECTRODE,DUNSPARCE,0
GiovanniData:
	db $FF,30,STEELIX,27,RHYHORN,29,PERSIAN,28,POLIWRATH,36,MURKROW,0
	db $FF,37,NIDOKING,35,PERSIAN,37,RHYDON,41,NIDOQUEEN,40,POLITOED,45,HOUNDOOM,0
	db $FF,50,DUGTRIO,53,PERSIAN,53,POLIWRATH,55,NIDOQUEEN,55,RHYPERIOR,60,ALAKAZAM,0
RocketData:
	...
	db 28,DROWZEE,LARVITAR,GRAVELER,0
	db 29,CUBONE,WOBBUFFET,CROBAT,0
	db 26,GOLBAT,HOUNDOUR,GLOOM,MISDREAVUS,HERACROSS,0
	db 28,STEELIX,HYPNO,RATICATE,0
	db 29,HITMONTOP,KADABRA,NOCTOWL,0
	db 28,HAUNTER,MAGMAR,CUBONE,QWILFISH,0
	db 35,ARBOK,YANMEGA,NOCTOWL,OCTILLERY,0
	db 35,HYPNO,WOBBUFFET,SCIZOR,FLAAFFY,0
	db 29,HOUNDOOM,MACHOKE,STANTLER,0
	db 28,QUAGSIRE,SKARMORY,CROBAT,0
	db 26,HOUNDOUR,ARBOK,KOFFING,DRATINI,0
	db 30,SNEASEL,CUBONE,GRANBULL,JUMPLUFF,0
	db 30,HONCHKROW,SANDSLASH,SUDOWOODO,0
	db 35,RATICATE,CROBAT,HOUNDOUR,MURKROW,0
	db 36,WEEZING,GOLDUCK,MAGCARGO,DUNSPARCE,0
	db 38,DROWZEE,GRIMER,MACHOKE,STANTLER,0
	db 45,HOUNDOOM,LANTURN,HYPNO,DELIBIRD,0
	db 43,MACHAMP,GENGAR,ALAKAZAM,DUNSPARCE,0
	db 40,SNEASEL,BLISSEY,CROBAT,SCIZOR,EKANS,0
...
;JessieJamesData:
	...
	db 32,MEOWTH,ARBOK,WEEZING,GROWLITHE,WEEPINBELL,LICKITUNG,0
	db 40,WEEZING,ARBOK,WOBBUFFET,ARCANINE,VICTREEBEL,LICKILICKY,0
...
CooltrainerFData:
	...
	db 47,PERSIAN,NINETALES,CLEFABLE,0
	db 50,BLASTOISE,CHARIZARD,VENUSAUR,RAICHU,0
	db 50,MAROWAK,NIDOQUEEN,WEAVILE,NINETALES,0
	db 47,PERSIAN,CLEFABLE,RAICHU,SKIPLOOM,0
...
ErikaData:
	db $FF,40,TANGROWTH,36,VICTREEBEL,34,VILEPLUME,38,SUNFLORA,36,VENUSAUR,40,EXEGGUTOR,0
KogaData:
	db $FF,50,SANDSLASH,46,MAROWAK,48,WEEZING,50,VENOMOTH,48,TENTACRUEL,50,SCIZOR,0
BlaineData:
	db $FF,50,NINETALES,50,RAPIDASH,55,ARCANINE,55,RHYDON,50,HYPNO,50,MAGMORTAR,0
SabrinaData:
	db $FF,55,MR_MIME,55,GIRAFARIG,55,ALAKAZAM,55,GENGAR,52,MISDREAVUS,60,STARMIE,0
GentlemanData:
...
Green2Data:
	...
	db $FF,30,FEAROW,25,VULPIX,25,MAGNEMITE,25,KADABRA,25,SANDSHREW,30,RAICHU,0
	...
	db $FF,47,SANDSLASH,45,EXEGGCUTE,45,NINETALES,47,CLOYSTER,50,KADABRA,56,RAICHU,0
	db $FF,47,SANDSLASH,45,EXEGGCUTE,45,CLOYSTER,47,RAICHU,50,KADABRA,56,SYLVEON,0
	db $FF,47,SANDSLASH,45,EXEGGCUTE,45,MAGNETON,47,RAICHU,50,KADABRA,56,ESPEON,0
Green3Data:
	db $FF,61,RHYPERIOR,59,ALAKAZAM,61,EXEGGUTOR,61,CLOYSTER,63,NINETALES,65,RAICHU,0
	db $FF,61,RHYPERIOR,59,ALAKAZAM,61,EXEGGUTOR,61,RAICHU,63,CLOYSTER,65,SYLVEON,0
	db $FF,61,RHYPERIOR,59,SANDSLASH,61,EXEGGUTOR,61,NINETALES,63,RAICHU,65,ESPEON,0

BrunoData:
	db $FF,53,STEELIX,55,LUCARIO,55,HITMONTOP,56,POLIWRATH,58,MACHAMP,60,MAMOSWINE,0
LoreleiData:
	db $FF,54,KINGDRA,53,CLOYSTER,54,SLOWKING,56,JYNX,56,LAPRAS,60,WEAVILE,0
ChannelerData:
	db 22,MISDREAVUS,0
	db 24,GASTLY,0
...
AgathaData:
	db $FF,56,GENGAR,56,CROBAT,55,NINETALES,58,ARBOK,60,MISMAGIUS,60,MAROWAK,0
LanceData:
	db $FF,58,GYARADOS,56,DRAGONAIR,56,TYRANITAR,60,AERODACTYL,62,DRAGONITE,60,CHARIZARD,0
