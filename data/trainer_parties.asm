...
; none. now RANDTRAINER
	db $FF,70,RHYPERIOR,69,BLASTOISE,71,EXEGGUTOR,71,HOUNDOOM,73,MAGNETON,75,ESPEON,0
  db $FF,50,SQUIRTLE,50,BULBASAUR,50,CHARMANDER,50,MEW,50,MEWTWO,50,RATTATA,0
FisherData:
