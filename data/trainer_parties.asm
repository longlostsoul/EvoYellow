...
BugCatcherData:
	db 7,SPINARAK,WOBBUFFET,WEEDLE,0
	...
	db 26,BUTTERFREE,MARILL,ARIADOS,0
...
JrTrainerFData:
	...
	db 26,BULBASAUR,LINOONE,MANTINE,0
...
Green1Data: ;Maybe could replace with Ash? hah.
	db 5,PIKACHU,0 
...
CooltrainerMData:
	...
	db 48,KINGLER,STARMIE,MILTANK,MAROWAK,0
	db 45,SNORLAX,BLASTOISE,VENUSAUR,CHARIZARD,0
	db 44,IVYSAUR,WARTORTLE,CHARMELEON,SMEARGLE,0
	db 55,NIDOKING,DONPHAN,DRAGONITE,JYNX,0
...
CooltrainerFData:
	...
	db 45,PARASECT,DEWGONG,CHANSEY,SMEARGLE,LINOONE,0
	db 48,VILEPLUME,ELECTIVIRE,BLISSEY,MANTINE,0
	db 47,PERSIAN,NINETALES,CLEFABLE,MAMOSWINE,0
	db 50,BLASTOISE,CHARIZARD,VENUSAUR,RAICHU,0
	db 50,MAROWAK,NIDOQUEEN,WEAVILE,NINETALES,NOCTOWL,SALAZZLE,0
	db 47,PERSIAN,CLEFABLE,RAICHU,SIRFETCHD,SKIPLOOM,GYARADOS,0
...
GentlemanData:
	...
	db 48,PRIMEAPE,JYNX,CURSOLA,SMEARGLE,0
...
ChannelerData:
	db 22,MISDREAVUS,0
	db 24,GASTLY,0
	db 23,GASTLY,CURSOLA,0
	db 24,HOOTHOOT,ARIADOS,0
	db 23,MISDREAVUS,0
	db 24,JYNX,0
	db 24,HAUNTER,0
	db 22,UMBREON,0
