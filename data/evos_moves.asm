...
MonSPINARAK: ;actually joltik now
  	;Evolutions
  db EV_LEVEL,20,GALVANTULA
	db 0
;Learnset
  db 6,CONSTRICT
	db 9,LEECH_LIFE
...
MonARIADOS:
  	;Evolutions. actually galvantula
	db 0
;Learnset
  db 6,CONSTRICT
	db 9,LEECH_LIFE
	db 10,ABSORB
	db 15,ELECTRO_BALL ;night shade
	db 18,FURY_SWIPES
	db 23,PIN_MISSILE ;hex
	db 30,THUNDERBOLT ;sludge
	db 32,SUCKER_PUNCH
	db 36,AGILITY
	db 41,PIN_MISSILE
	db 46,THUNDER ;psychic
	db 50,BUG_BUZZ
	db 0
