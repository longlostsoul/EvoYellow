FishingSlots::
	db PALLET_TOWN,STARYU,10,TENTACOOL,10,STARYU,5,CHINCHOU,20
	db VIRIDIAN_CITY,POLIWAG,5,POLIWAG,10,POLIWAG,15,POLIWAG,10
	db CERULEAN_CITY,GOLDEEN,25,CORSOLA,30,SEAKING,30,SEAKING,40
	...
	db ROUTE_4,GOLDEEN,20,MARILL,25,GOLDEEN,30,SEAKING,30
	db ROUTE_6,GOLDEEN,5,GOLDEEN,10,CORSOLA,15,GOLDEEN,20
	db ROUTE_24,GOLDEEN,20,MARILL,25,GOLDEEN,30,SEAKING,30
	db ROUTE_25,KRABBY,10,KRABBY,15,KINGLER,15,KINGLER,25
	db ROUTE_10,KRABBY,15,KRABBY,20,HORSEA,10,KINGLER,25
	db ROUTE_11,TENTACOOL,15,HORSEA,20,CHINCHOU,10,HORSEA,5
	...
	db SAFARI_ZONE_CENTER,MAGIKARP,5,CHINCHOU,10,DRATINI,10,DRAGONAIR,15
	db SAFARI_ZONE_EAST,MAGIKARP,5,CHINCHOU,10,MAGIKARP,15,DRATINI,15
	db SAFARI_ZONE_NORTH,MAGIKARP,5,MARILL,10,MAGIKARP,15,DRATINI,15
	db SAFARI_ZONE_WEST,MAGIKARP,5,CORSOLA,10,MAGIKARP,15,DRATINI,15
