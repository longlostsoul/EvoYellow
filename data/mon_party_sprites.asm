...
; PIKACHU = A
	...
	dn SPRITE_MON, SPRITE_FAIRY                                ;Mew/Togepi
  dn SPRITE_FAIRY, SPRITE_FAIRY                                ;Togetic/Togekiss
  dn SPRITE_QUADRUPED, SPRITE_QUADRUPED ;Houndour/Houndoom
  dn SPRITE_BUG, SPRITE_BIRD_M                                  ;Heracross/CROBAT
	dn SPRITE_MON, SPRITE_MON   ;sneasels ' rearranged things, need to fix eventually >_>
	dn SPRITE_BIRD_M, SPRITE_FAIRY                                ;SKARM,Mis
	dn SPRITE_FAIRY, SPRITE_QUADRUPED                              ;Mismagius,Miltank
	dn SPRITE_WATER, SPRITE_WATER                                ;Chinchou,Lanturn
	dn SPRITE_QUADRUPED,SPRITE_QUADRUPED;SPRITE_SNAKE, SPRITE_SNAKE                               ;wasSlugma,Mag
	dn SPRITE_MON, SPRITE_MON                                ;Ty,Hitmon
	dn SPRITE_BIRD_M, SPRITE_BIRD_M                                ;Murkrow,Hon
	dn SPRITE_PIKACHU_FAMILY, SPRITE_PIKACHU_FAMILY                                ;Marill,Azu
	dn SPRITE_QUADRUPED, SPRITE_QUADRUPED                               ;Swinn,Pilo
	dn SPRITE_QUADRUPED, SPRITE_MON                                ;Mamo,Woop
		dn SPRITE_MON, SPRITE_BUG                                ;Quags,Yanm
	dn SPRITE_BUG, SPRITE_MON                                ;Yan,Pory
	dn SPRITE_QUADRUPED, SPRITE_QUADRUPED                               ;Phanpy,Don
	dn SPRITE_MON, SPRITE_MON                               ;Gligar,g
	...
	dn SPRITE_WATER, SPRITE_QUADRUPED ;oct,RIME  
  ...
  dn SPRITE_MON, SPRITE_MON;riolu,lucario
	...
	dn SPRITE_SNAKE,SPRITE_QUADRUPED;steelix, ZIGZAGOON
  dn SPRITE_QUADRUPED,SPRITE_MON;LINOONE, OBSTAGOON
  dn SPRITE_BUG,SPRITE_BUG;SPINARA KARIADOS,
  dn  SPRITE_GRASS,SPRITE_WATER; MANTYKE.MANTINE,
  dn SPRITE_BUG,SPRITE_BUG; was AIPOM AMBIPOM,
  dn SPRITE_MON,SPRITE_PIKACHU_FAMILY; MUNCHLAX SMEARGLE,
  dn SPRITE_QUADRUPED, SPRITE_QUADRUPED; SUICUNE ENTEI
  dn SPRITE_QUADRUPED, SPRITE_MON;. RAIKOU MEGA_CHARIZARD
;  dn SPRITE_MON,SPRITE_GRASS;, MEGA_BLASTOISE MEGA_VENUSAUR
;  dn SPRITE_MON ;wobbuffet
